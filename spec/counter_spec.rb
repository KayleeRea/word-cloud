  ...
  it 'returns the words as a hash of another hash with how many times that word was said and who said it' do
    ...
    expect(Counter.new(data).words).to eq(
                                         {"optimize" => {:count => 1, :people => ["Ila Huels"]},
                                          ...
                                          "benchmark" =>
                                            {:count => 3, :people => ["Ila Huels", "Cristopher Feest"]},
  ...
  it 'Works with a JSON file' do
    ...
    expect(Counter.new(data).words).to include(
                                         {"bricks-and-clicks" => {:count => 6, :people => ["Josefa McGlynn", "Avis McCullough Jr.", "Shana Kutch", "Joanny Barton", "Shad Muller", "Stephon Wehner MD"]},
                                          "channels" => {:count => 8, :people => ["Cristopher Feest", "Mrs. Ken Brown", "Alvah Jacobi", "Kobe Hansen II", "Shad Muller", "Dr. Halle McDermott", "Mr. German Buckridge"]},
                                          "clicks-and-mortar" => {:count => 5, :people => ["Mrs. Ken Brown", "Kobe Hansen II", "Gertrude Heaney", "Mr. German Buckridge"]},
                                          "collaborative" => {:count => 4, :people => ["Teagan Gutkowski", "Earl Prosacco", "Elias Conn I", "Dariana Ondricka"]},
                                          "communities" => {:count => 12, :people => ["Ila Huels", "Cristopher Feest", "Mr. Maryam Bradtke", "Shana Kutch", "Joanny Barton", "Kobe Hansen II", "Dariana Ondricka", "Kailey Davis", "Aryanna Mohr", "Emilia Schaefer"]},
                                          ...
                                          "cross-media" => {:count => 7, :people => ["Mrs. Ken Brown", "Orpha Predovic", "Elvis Rodriguez", "Gertrude Heaney"]},
                                          "cross-platform" => {:count => 4, :people => ["Cristopher Feest", "Shana Kutch", "Shad Muller", "Vance Rowe"]},
                                          "cultivate" => {:count => 4, :people => ["Mrs. Ken Brown", "Avis McCullough Jr.", "Gertrude Heaney"]},
                                          "customized" => {:count => 5, :people => ["Shana Kutch", "Shad Muller", "Kailey Davis", "Elvis Rodriguez"]},
                                          "cutting-edge" => {:count => 6, :people => ["Mrs. Ken Brown", "Kobe Hansen II", "Elias Conn I", "Dariana Ondricka", "Emilia Schaefer"]},
                                          ...
                                          "deliverables" => {:count => 8, :people => ["Mrs. Ken Brown", "Mr. Maryam Bradtke", "Dariana Ondricka", "Dr. Halle McDermott", "Vance Rowe", "Elvis Rodriguez"]},
                                          "deploy" => {:count => 7, :people => ["Gennaro Moore DDS", "Mrs. Ken Brown", "Avis McCullough Jr.", "Joanny Barton", "Earl Prosacco", "Dr. Halle McDermott"]},
